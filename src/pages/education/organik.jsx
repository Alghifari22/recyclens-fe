        ...
        <div className="container mx-auto max-w-[1240px] flex flex-col md:flex-row items-center">
          <div className="w-full text-center md:text-left">
            ...
            <div className="flex flex-col lg:flex-row gap-4 mt-8 lg:mt-16 p-4 max-w-screen-lg mx-auto">
              {/* Sisa Makanan Card */}
              <div className="bg-[#B9FF66] border-2 border-black-500 rounded-[32px] p-4 lg:p-6 text-center w-full lg:w-[420px] shadow-xl shadow-black/50 mx-auto lg:mx-0">
                <h3 className="text-green-800 font-semibold mb-2 text-sm sm:text-base">
                  Sisa Makanan
                </h3>
              ...
              {/* Dedaunan Card */}
              <div className="bg-[#B9FF66] border-2 border-black-500 rounded-[32px] p-4 lg:p-6 text-center w-full lg:w-[420px] shadow-xl shadow-black/50 mx-auto lg:mx-0">
                <h3 className="text-green-800 font-semibold mb-2 text-sm sm:text-base">Dedaunan</h3>
                <hr className="border-black-500 my-4" />
                <p className="text-green-700 text-xs sm:text-sm">
